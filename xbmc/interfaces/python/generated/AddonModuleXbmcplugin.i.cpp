...
namespace PythonBindings
{
  ...
  static PyObject* xbmcplugin_addDirectoryItems (PyObject* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    if(pyentry1)
    {
      ...
      if (vecSize > 2)
      {
        ...
        bool  entry2_2;
        entry2_2 = (PyLong_AsLong(pyentry2_2) == 0L ? false : true);
  ...
  static PyObject* xbmcplugin_addSortMethod (PyObject* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    int  handle ;
    int  sortMethod ;
    std::string  labelMask  = XBMCAddon::emptyString;
    PyObject* pylabelMask = NULL;
    ...
    try
    {
      if (pylabelMask) PyXBMCGetUnicodeString(labelMask,pylabelMask,false,"labelMask","XBMCAddon::xbmcplugin::addSortMethod"); 
      if (pylabel2Mask) PyXBMCGetUnicodeString(label2Mask,pylabel2Mask,false,"label2Mask","XBMCAddon::xbmcplugin::addSortMethod"); 

      XBMCAddon::SetLanguageHookGuard slhg(XBMCAddon::Python::PythonLanguageHook::GetIfExists(PyThreadState_Get()->interp).get());
      XBMCAddon::xbmcplugin::addSortMethod(  handle,  sortMethod,  labelMask,  label2Mask  );
  ...
  PyObject *PyInit_Module_xbmcplugin()
  {
   ...
   PyModule_AddIntConstant(module,"SORT_METHOD_NONE",static_cast< int >(SortMethod::NONE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_LABEL",static_cast< int >(SortMethod::LABEL)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_LABEL_IGNORE_THE",static_cast< int >(SortMethod::LABEL_IGNORE_THE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_DATE",static_cast< int >(SortMethod::DATE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_SIZE",static_cast< int >(SortMethod::SIZE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_FILE",static_cast< int >(SortMethod::FILE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_DRIVE_TYPE",static_cast< int >(SortMethod::DRIVE_TYPE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_TRACKNUM",static_cast< int >(SortMethod::TRACKNUM)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_DURATION",static_cast< int >(SortMethod::DURATION)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_TITLE",static_cast< int >(SortMethod::TITLE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_TITLE_IGNORE_THE",static_cast< int >(SortMethod::TITLE_IGNORE_THE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_ARTIST",static_cast< int >(SortMethod::ARTIST)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_ARTIST_IGNORE_THE",static_cast< int >(SortMethod::ARTIST_IGNORE_THE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_ALBUM",static_cast< int >(SortMethod::ALBUM)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_ALBUM_IGNORE_THE",static_cast< int >(SortMethod::ALBUM_IGNORE_THE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_GENRE",static_cast< int >(SortMethod::GENRE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_VIDEO_YEAR",static_cast< int >(SortMethod::YEAR)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_VIDEO_RATING",static_cast< int >(SortMethod::VIDEO_RATING)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_PROGRAM_COUNT",static_cast< int >(SortMethod::PROGRAM_COUNT)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_PLAYLIST_ORDER",static_cast< int >(SortMethod::PLAYLIST_ORDER)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_EPISODE",static_cast< int >(SortMethod::EPISODE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_VIDEO_TITLE",static_cast< int >(SortMethod::VIDEO_TITLE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_VIDEO_SORT_TITLE",static_cast< int >(SortMethod::VIDEO_SORT_TITLE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_VIDEO_SORT_TITLE_IGNORE_THE",static_cast< int >(SortMethod::VIDEO_SORT_TITLE_IGNORE_THE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_VIDEO_ORIGINAL_TITLE",static_cast< int >(SortMethod::VIDEO_ORIGINAL_TITLE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_VIDEO_ORIGINAL_TITLE_IGNORE_THE",static_cast< int >(SortMethod::VIDEO_ORIGINAL_TITLE_IGNORE_THE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_PRODUCTIONCODE",static_cast< int >(SortMethod::PRODUCTIONCODE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_SONG_RATING",static_cast< int >(SortMethod::SONG_RATING)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_MPAA_RATING",static_cast< int >(SortMethod::MPAA_RATING)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_VIDEO_RUNTIME",static_cast< int >(SortMethod::VIDEO_RUNTIME)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_STUDIO",static_cast< int >(SortMethod::STUDIO)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_STUDIO_IGNORE_THE",static_cast< int >(SortMethod::STUDIO_IGNORE_THE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_UNSORTED",static_cast< int >(SortMethod::UNSORTED)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_BITRATE",static_cast< int >(SortMethod::BITRATE)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_LISTENERS",static_cast< int >(SortMethod::LISTENERS)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_COUNTRY",static_cast< int >(SortMethod::COUNTRY)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_DATEADDED",static_cast< int >(SortMethod::DATEADDED)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_FULLPATH",static_cast< int >(SortMethod::FULLPATH)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_LABEL_IGNORE_FOLDERS",static_cast< int >(SortMethod::LABEL_IGNORE_FOLDERS)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_LASTPLAYED",static_cast< int >(SortMethod::LASTPLAYED)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_PLAYCOUNT",static_cast< int >(SortMethod::PLAYCOUNT)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_CHANNEL",static_cast< int >(SortMethod::CHANNEL)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_DATE_TAKEN",static_cast< int >(SortMethod::DATE_TAKEN)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_VIDEO_USER_RATING",static_cast< int >(SortMethod::VIDEO_USER_RATING)); 
   PyModule_AddIntConstant(module,"SORT_METHOD_SONG_USER_RATING",static_cast< int >(SortMethod::SONG_USER_RATING)); 
  // constexpr constants
