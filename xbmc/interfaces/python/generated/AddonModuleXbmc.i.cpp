...
namespace PythonBindings
{
  ...
  static PyObject* xbmc_XBMCAddon_xbmc_Player_isPlayingGame (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    XBMC_TRACE;
    bool  apiResult;
    try
    {
      ...
      apiResult = ((XBMCAddon::xbmc::Player*)retrieveApiInstance((PyObject*)self,&TyXBMCAddon_xbmc_Player_Type,"isPlayingGame","XBMCAddon::xbmc::Player"))-> isPlayingGame(  );
    ...
    {
      CLog::Log(LOGERROR,"EXCEPTION: Unknown exception thrown from the call \"isPlayingGame\"");
      PyErr_SetString(PyExc_RuntimeError, "Unknown exception thrown from the call \"isPlayingGame\""); 
      return NULL; 
    }
  ...
  static PyObject* xbmc_XBMCAddon_xbmc_Player_getGameInfoTag (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    XBMC_TRACE;
    InfoTagGame * apiResult;
    try
    {

      apiResult = ((XBMCAddon::xbmc::Player*)retrieveApiInstance((PyObject*)self,&TyXBMCAddon_xbmc_Player_Type,"getGameInfoTag","XBMCAddon::xbmc::Player"))-> getGameInfoTag(  );
  ...
  static PyObject* xbmc_XBMCAddon_xbmc_InfoTagMusic_getSongVideoURL (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    XBMC_TRACE;
    XBMCAddon::String  apiResult;
    try
    {
      ...
      apiResult = ((XBMCAddon::xbmc::InfoTagMusic*)retrieveApiInstance((PyObject*)self,&TyXBMCAddon_xbmc_InfoTagMusic_Type,"getSongVideoURL","XBMCAddon::xbmc::InfoTagMusic"))-> getSongVideoURL(  );
    ...
    {
      CLog::Log(LOGERROR,"EXCEPTION: Unknown exception thrown from the call \"getSongVideoURL\"");
      PyErr_SetString(PyExc_RuntimeError, "Unknown exception thrown from the call \"getSongVideoURL\""); 
      return NULL; 
    }
  ...
  static PyObject* xbmc_XBMCAddon_xbmc_InfoTagMusic_setSongVideoURL (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    XBMC_TRACE;
    ...
    try
    {
      if (pysongVideoURL) PyXBMCGetUnicodeString(songVideoURL,pysongVideoURL,false,"songVideoURL","setSongVideoURL"); 

      ((XBMCAddon::xbmc::InfoTagMusic*)retrieveApiInstance((PyObject*)self,&TyXBMCAddon_xbmc_InfoTagMusic_Type,"setSongVideoURL","XBMCAddon::xbmc::InfoTagMusic"))-> setSongVideoURL(  songVideoURL  );
    ...
    {
      CLog::Log(LOGERROR,"EXCEPTION: Unknown exception thrown from the call \"setSongVideoURL\"");
      PyErr_SetString(PyExc_RuntimeError, "Unknown exception thrown from the call \"setSongVideoURL\""); 
      return NULL; 
    }
  ...
  static PyObject* xbmc_XBMCAddon_xbmc_InfoTagVideo_getOriginalLanguage (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    XBMC_TRACE;
    XBMCAddon::String  apiResult;
    try
    {
      ...
      apiResult = ((XBMCAddon::xbmc::InfoTagVideo*)retrieveApiInstance((PyObject*)self,&TyXBMCAddon_xbmc_InfoTagVideo_Type,"getOriginalLanguage","XBMCAddon::xbmc::InfoTagVideo"))-> getOriginalLanguage(  );
    ...
    {
      CLog::Log(LOGERROR,"EXCEPTION: Unknown exception thrown from the call \"getOriginalLanguage\"");
      PyErr_SetString(PyExc_RuntimeError, "Unknown exception thrown from the call \"getOriginalLanguage\""); 
      return NULL; 
    }
  ...
  static PyObject* xbmc_XBMCAddon_xbmc_InfoTagVideo_setUniqueIDs (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    std::map< XBMCAddon::String ,XBMCAddon::String ,std::less< >  >  uniqueIDs ;
  ...
  static PyObject* xbmc_XBMCAddon_xbmc_InfoTagVideo_setOriginalLanguage (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    XBMC_TRACE;
    ...
    try
    {
      if (pylanguage) PyXBMCGetUnicodeString(language,pylanguage,false,"language","setOriginalLanguage"); 

      apiResult = ((XBMCAddon::xbmc::InfoTagVideo*)retrieveApiInstance((PyObject*)self,&TyXBMCAddon_xbmc_InfoTagVideo_Type,"setOriginalLanguage","XBMCAddon::xbmc::InfoTagVideo"))-> setOriginalLanguage(  language  );
    ...
    {
      CLog::Log(LOGERROR,"EXCEPTION: Unknown exception thrown from the call \"setOriginalLanguage\"");
      PyErr_SetString(PyExc_RuntimeError, "Unknown exception thrown from the call \"setOriginalLanguage\""); 
      return NULL; 
    }
  ...
  static PyObject* xbmc_XBMCAddon_xbmc_InfoTagVideo_setVideoAssetTitle (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    XBMC_TRACE;
    ...
    std::string  videoAssetTitle ;
    PyObject* pyvideoAssetTitle = NULL;
    if (!PyArg_ParseTupleAndKeywords(
       args,
       kwds,
       "O",
    ...
    try
    {
      if (pyvideoAssetTitle) PyXBMCGetUnicodeString(videoAssetTitle,pyvideoAssetTitle,false,"videoAssetTitle","setVideoAssetTitle"); 

      ((XBMCAddon::xbmc::InfoTagVideo*)retrieveApiInstance((PyObject*)self,&TyXBMCAddon_xbmc_InfoTagVideo_Type,"setVideoAssetTitle","XBMCAddon::xbmc::InfoTagVideo"))-> setVideoAssetTitle(  videoAssetTitle  );
    ...
    {
      CLog::Log(LOGERROR,"EXCEPTION: Unknown exception thrown from the call \"setVideoAssetTitle\"");
      PyErr_SetString(PyExc_RuntimeError, "Unknown exception thrown from the call \"setVideoAssetTitle\""); 
      return NULL; 
    }
  ...
  static PyObject* xbmc_XBMCAddon_xbmc_InfoTagVideo_addSeason (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    try
    {
      ...
      if (pyplot) PyXBMCGetUnicodeString(plot,pyplot,false,"plot","addSeason"); 

      ((XBMCAddon::xbmc::InfoTagVideo*)retrieveApiInstance((PyObject*)self,&TyXBMCAddon_xbmc_InfoTagVideo_Type,"addSeason","XBMCAddon::xbmc::InfoTagVideo"))-> addSeason(  number,  name,  plot  );
  ...
  static PyObject* xbmc_XBMCAddon_xbmc_InfoTagVideo_addSeasons (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    std::vector< Tuple< int ,std::string ,std::string  >  >  seasons ;
    PyObject* pyseasons = NULL;
    if (!PyArg_ParseTupleAndKeywords(
       args,
       kwds,
       "O",
    ...
    if (pyseasons)
    {
      bool isTuple = PyObject_TypeCheck(pyseasons,&PyTuple_Type);
      if (!isTuple && !PyObject_TypeCheck(pyseasons,&PyList_Type))
        throw WrongTypeException("The parameter \"seasons\" must be either a Tuple or a List.");

      
      PyObject *pyentry1 = NULL;
      Py_ssize_t vecSize = (isTuple ? PyTuple_Size(pyseasons) : PyList_Size(pyseasons));
      seasons.reserve(vecSize);
      for(Py_ssize_t i = 0; i < vecSize; i++)
      {
        pyentry1 = (isTuple ? PyTuple_GetItem(pyseasons, i) : PyList_GetItem(pyseasons, i));
        Tuple< int ,std::string ,std::string  >  entry1;
    ...
    if(pyentry1)
    {
      ...
      if (vecSize > 2)
      {
        ...
        std::string  entry2_2;
        if (pyentry2_2) PyXBMCGetUnicodeString(entry2_2,pyentry2_2,false,"entry2_2","addSeasons");
        entry1.third() = entry2_2;
      }

    }

        seasons.push_back(std::move(entry1));
      }
    }
 

      ((XBMCAddon::xbmc::InfoTagVideo*)retrieveApiInstance((PyObject*)self,&TyXBMCAddon_xbmc_InfoTagVideo_Type,"addSeasons","XBMCAddon::xbmc::InfoTagVideo"))-> addSeasons(  seasons  );
  ...
  static PyObject* xbmc_XBMCAddon_xbmc_InfoTagVideo_setAvailableFanart (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    XBMC_TRACE;
        ...
        
    {
      ...
      ((XBMCAddon::xbmc::InfoTagVideo*)retrieveApiInstance((PyObject*)self,&TyXBMCAddon_xbmc_InfoTagVideo_Type,"setAvailableFanart","XBMCAddon::xbmc::InfoTagVideo"))-> setAvailableFanart(  images  );
  ...
  static PyMethodDef XBMCAddon_xbmc_Player_methods[] = { 
    ...
    {"isPlayingGame", (PyCFunction)xbmc_XBMCAddon_xbmc_Player_isPlayingGame, METH_VARARGS|METH_KEYWORDS, NULL }, 
    ...
    {"getGameInfoTag", (PyCFunction)xbmc_XBMCAddon_xbmc_Player_getGameInfoTag, METH_VARARGS|METH_KEYWORDS, NULL }, 
  ...
  static PyMethodDef XBMCAddon_xbmc_InfoTagMusic_methods[] = { 
    ...
    {"getSongVideoURL", (PyCFunction)xbmc_XBMCAddon_xbmc_InfoTagMusic_getSongVideoURL, METH_VARARGS|METH_KEYWORDS, NULL }, 
    ...
    {"setSongVideoURL", (PyCFunction)xbmc_XBMCAddon_xbmc_InfoTagMusic_setSongVideoURL, METH_VARARGS|METH_KEYWORDS, NULL }, 
    {NULL, NULL, 0, NULL}
  };
  ...
  static PyMethodDef XBMCAddon_xbmc_InfoTagVideo_methods[] = { 
    ...
    {"getOriginalLanguage", (PyCFunction)xbmc_XBMCAddon_xbmc_InfoTagVideo_getOriginalLanguage, METH_VARARGS|METH_KEYWORDS, NULL }, 
    ...
    {"setOriginalLanguage", (PyCFunction)xbmc_XBMCAddon_xbmc_InfoTagVideo_setOriginalLanguage, METH_VARARGS|METH_KEYWORDS, NULL }, 
    ...
    {"setVideoAssetTitle", (PyCFunction)xbmc_XBMCAddon_xbmc_InfoTagVideo_setVideoAssetTitle, METH_VARARGS|METH_KEYWORDS, NULL }, 
    ...
    {"setAvailableFanart", (PyCFunction)xbmc_XBMCAddon_xbmc_InfoTagVideo_setAvailableFanart, METH_VARARGS|METH_KEYWORDS, NULL }, 
    {NULL, NULL, 0, NULL}
  };
