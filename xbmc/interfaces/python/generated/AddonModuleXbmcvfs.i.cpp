...
namespace PythonBindings
{
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_File___enter__ (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    XBMC_TRACE;
    XBMCAddon::xbmcvfs::File * apiResult;
    try
    {
      ...
      apiResult = ((XBMCAddon::xbmcvfs::File*)retrieveApiInstance((PyObject*)self,&TyXBMCAddon_xbmcvfs_File_Type,"__enter__","XBMCAddon::xbmcvfs::File"))-> __enter__(  );
    ...
    {
      CLog::Log(LOGERROR,"EXCEPTION: Unknown exception thrown from the call \"__enter__\"");
      PyErr_SetString(PyExc_RuntimeError, "Unknown exception thrown from the call \"__enter__\""); 
      return NULL; 
    }
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_File___exit__ (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    XBMC_TRACE;
    ...
    try
    {
      ...
      ((XBMCAddon::xbmcvfs::File*)retrieveApiInstance((PyObject*)self,&TyXBMCAddon_xbmcvfs_File_Type,"__exit__","XBMCAddon::xbmcvfs::File"))-> __exit__(  );
    ...
    {
      CLog::Log(LOGERROR,"EXCEPTION: Unknown exception thrown from the call \"__exit__\"");
      PyErr_SetString(PyExc_RuntimeError, "Unknown exception thrown from the call \"__exit__\""); 
      return NULL; 
    }
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_File_read (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    // transform the result
    result = PyUnicode_DecodeUTF8(apiResult.c_str(),apiResult.size(),"strict");
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_File_write (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    {
      Py_ssize_t pysize;
      const char* str = PyUnicode_AsUTF8AndSize(pybuffer, &pysize);
    ...
    {
      Py_ssize_t pysize = PyBytes_GET_SIZE(pybuffer);
      const char* str = PyBytes_AS_STRING(pybuffer);
      size_t size = static_cast<size_t>(pysize);
      buffer.allocate(size);
      buffer.put(str, size);
      buffer.flip(); // prepare the buffer for reading from
    ...
    {
      throw XBMCAddon::WrongTypeException("argument \"%s\" for \"%s\" must be a string, bytes or a bytearray", "buffer", "write");
    } 
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_File_tell (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    XBMC_TRACE;
    long long  apiResult;
    try
    {
      ...
      apiResult = ((XBMCAddon::xbmcvfs::File*)retrieveApiInstance((PyObject*)self,&TyXBMCAddon_xbmcvfs_File_Type,"tell","XBMCAddon::xbmcvfs::File"))-> tell(  );
    ...
    {
      CLog::Log(LOGERROR,"EXCEPTION: Unknown exception thrown from the call \"tell\"");
      PyErr_SetString(PyExc_RuntimeError, "Unknown exception thrown from the call \"tell\""); 
      return NULL; 
    }
  ...
  static PyObject* xbmcvfs_makeLegalFilename (PyObject* self  , PyObject *args, PyObject *kwds  )
  {
    XBMC_TRACE;
    ...
    try
    {
      if (pyfilename) PyXBMCGetUnicodeString(filename,pyfilename,false,"filename","XBMCAddon::xbmcvfs::makeLegalFilename"); 

      XBMCAddon::SetLanguageHookGuard slhg(XBMCAddon::Python::PythonLanguageHook::GetIfExists(PyThreadState_Get()->interp).get());
      apiResult = XBMCAddon::xbmcvfs::makeLegalFilename(  filename  );
    ...
    {
      CLog::Log(LOGERROR,"EXCEPTION: Unknown exception thrown from the call \"XBMCAddon::xbmcvfs::makeLegalFilename\"");
      PyErr_SetString(PyExc_RuntimeError, "Unknown exception thrown from the call \"XBMCAddon::xbmcvfs::makeLegalFilename\""); 
      return NULL; 
    }
  ...
  static PyObject* xbmcvfs_translatePath (PyObject* self  , PyObject *args, PyObject *kwds  )
  {
    XBMC_TRACE;
    ...
    try
    {
      if (pypath) PyXBMCGetUnicodeString(path,pypath,false,"path","XBMCAddon::xbmcvfs::translatePath"); 

      XBMCAddon::SetLanguageHookGuard slhg(XBMCAddon::Python::PythonLanguageHook::GetIfExists(PyThreadState_Get()->interp).get());
      apiResult = XBMCAddon::xbmcvfs::translatePath(  path  );
    ...
    {
      CLog::Log(LOGERROR,"EXCEPTION: Unknown exception thrown from the call \"XBMCAddon::xbmcvfs::translatePath\"");
      PyErr_SetString(PyExc_RuntimeError, "Unknown exception thrown from the call \"XBMCAddon::xbmcvfs::translatePath\""); 
      return NULL; 
    }
  ...
  static PyObject* xbmcvfs_validatePath (PyObject* self  , PyObject *args, PyObject *kwds  )
  {
    XBMC_TRACE;
    ...
    try
    {
      if (pypath) PyXBMCGetUnicodeString(path,pypath,false,"path","XBMCAddon::xbmcvfs::validatePath"); 

      XBMCAddon::SetLanguageHookGuard slhg(XBMCAddon::Python::PythonLanguageHook::GetIfExists(PyThreadState_Get()->interp).get());
      apiResult = XBMCAddon::xbmcvfs::validatePath(  path  );
    ...
    {
      CLog::Log(LOGERROR,"EXCEPTION: Unknown exception thrown from the call \"XBMCAddon::xbmcvfs::validatePath\"");
      PyErr_SetString(PyExc_RuntimeError, "Unknown exception thrown from the call \"XBMCAddon::xbmcvfs::validatePath\""); 
      return NULL; 
    }
  ...
  static PyObject* xbmcvfs_listdir (PyObject* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    result = PyTuple_New(vecSize);
    {
      ...
      {
        PyObject* pyentry3;
        pyentry3 = PyUnicode_DecodeUTF8((*iter).c_str(),(*iter).size(),"surrogateescape");
  ...
  static PyMethodDef XBMCAddon_xbmcvfs_File_methods[] = { 
    {"__enter__", (PyCFunction)xbmcvfs_XBMCAddon_xbmcvfs_File___enter__, METH_VARARGS|METH_KEYWORDS, NULL }, 
    {"__exit__", (PyCFunction)xbmcvfs_XBMCAddon_xbmcvfs_File___exit__, METH_VARARGS|METH_KEYWORDS, NULL }, 
    ...
    {"tell", (PyCFunction)xbmcvfs_XBMCAddon_xbmcvfs_File_tell, METH_VARARGS|METH_KEYWORDS, NULL }, 
  ...
  static PyMethodDef xbmcvfs_methods[] = { 
    ...
    {"makeLegalFilename", (PyCFunction)xbmcvfs_makeLegalFilename, METH_VARARGS|METH_KEYWORDS, NULL }, 
    {"translatePath", (PyCFunction)xbmcvfs_translatePath, METH_VARARGS|METH_KEYWORDS, NULL }, 
    {"validatePath", (PyCFunction)xbmcvfs_validatePath, METH_VARARGS|METH_KEYWORDS, NULL }, 
